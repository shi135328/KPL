...
public class ClockView extends View {
    ...
    private static final int DEAFAULT_TITLE_SIZE = 8;
    ...
    private void drawPointerLine(Canvas canvas){
        canvas.rotate(135);
        for (int i=0; i<31; i++){     //一共需要绘制101个表针
    ...
    private void drawPointerText(Canvas canvas, int i){
        ...
        canvas.rotate(360 - 135 - 9f * i);        //坐标系总旋转角度为360度
    ...
    private void drawPointer(Canvas canvas){
        int currentDegree = (int) (currentValue* 9 + 135);
