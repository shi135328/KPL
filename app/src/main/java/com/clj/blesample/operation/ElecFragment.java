...
public class ElecFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.elec, null);
    ...
    private void initView(View v) {
        //导航栏菜单
        //控制按钮
        Button btnbtn = (Button)v.findViewById(R.id.button0);
        btnbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.e("跳转","changePage(0)");
                ((ControlActivity) getActivity()).changePage(0);
            }
        });
        //按钮按钮
        Button btnelec = (Button)v.findViewById(R.id.button1);
    ...
    public void showData() {
        ...
        //启动车辆
        Button btnread = (Button)v.findViewById(R.id.button3);
